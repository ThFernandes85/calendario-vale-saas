...
-- ============================================================
-- SALA DE CONTROLE: site PRÓPRIO e SEPARADO da Mutuca (decisão revista --
-- ligar direto no site 'MUTUCA' faria a Sala de Controle herdar também as
-- limpezas do Encarregado misturadas com o status das correias, o que gera
-- conflito visual/operacional no painel. Melhor manter os dois mundos
-- isolados: 'MUTUCA' (Limpeza Industrial / Mutuca - LI & Controle) sem o
-- painel, e um site próprio 'MUTUCA_SALA_CONTROLE' com sua própria cópia
-- das 5 áreas e 93 ativos, alimentado só pelos Técnicos de Manutenção/
-- Operação -- sem nenhuma sincronização entre os dois.
-- ============================================================
update public.sites set correias_panel = false where key = 'MUTUCA';
